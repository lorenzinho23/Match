...
if (isset($_POST["username"]) && isset($_POST["sesso"]) && isset($_POST["gusto"]) && isset($_POST["capelli"]) && isset($_POST["carattere"])) {
    ...
    $query = "INSERT INTO prede (nome, cognome, username, numero_tavolo, capelli, carattere, sesso, gusto,match_num) VALUES ('$nome','$cognome','$username','$numero_tavolo','$capelli','$carattere','$sesso','$gusto',0)";
...
<body>
    <p style="display: none;" id="tipo_test">preda</p>
    <h1>INIZIO TEST - versione preda</h1>
    <form id="quizForm" action="test_preda.php" method='POST'>
        <ol>
            <!-- NOME !-->
            <li>
            ...
            <!-- COLORE CAPELLI !-->
            <li>
                <h2>Quale è il tuo colore di capelli?</h2>
            ...
            <!-- CARATTERE !-->
            <li>
                <h2>Quale caratteristica ti rispecchia?</h2>
